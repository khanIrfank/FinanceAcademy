...
import { Mail, Lock, ArrowLeft, ShieldCheck, UserCheck, Eye, EyeOff } from 'lucide-react'
...
const Login = () => {
    ...
    const handleSubmit = (e) => {
        ...
        setTimeout(() => {
            setIsLoading(false)
            alert('Login successful! Connecting to Dark Horse Trading terminals...')
            navigate('/')
        }, 2000)
    }
            ...
            <div className="relative z-10 w-full max-w-md">
                ...
                <div className="rounded-2xl border border-gold-medium/30 p-8 sm:p-10 bg-dark-950/90 shadow-2xl glass-card glow-gold">
                    ...
                    <div className="text-center space-y-2 mb-8">
                        ...
                        <h2 className="text-2xl font-bold font-display uppercase tracking-widest text-white mt-3">Welcome Back</h2>
                        <p className="text-xs text-gray-500">Sign in to sync with the Dark Horse global network.</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="space-y-1.5">
                            <div className="flex justify-between items-center">
                                ...
                                <Link to="/forgot-password" className="text-[11px] text-gold-medium hover:text-gold-light hover:underline font-semibold">
                                    Key Loss?
                                </Link>
                            </div>
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full bg-dark-900 border border-gold-dark/20 rounded-lg pl-10 pr-10 py-3 text-sm text-gray-200 placeholder-gray-600 focus:outline-none focus:border-gold-medium/60 focus:ring-1 focus:ring-gold-medium/60 transition-colors"
                                />
                                <button
                                    type="button"
                                    onClick={() => setShowPassword(!showPassword)}
                                    className="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-500 hover:text-gold-light cursor-pointer"
                                >
                    ...
                    <div className="mt-8 pt-6 border-t border-gold-dark/10 text-center text-xs">
                        <span className="text-gray-500">Not part of the Elite alliance? </span>
                        <Link to="/register" className="text-gold-medium hover:text-gold-light hover:underline font-bold">
                            Join Elite Club
                        </Link>
                    </div>
