      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center space-y-3 mb-16">
          ...
          <p className={`text-sm max-w-2xl mx-auto leading-relaxed ${isDark ? 'text-gray-400' : 'text-[#8a7050]'}`}>
            Envisioned as a diversified investment ecosystem, Dark Horse is designed to bring together multiple financial sectors under one unified platform.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
          ...
          {/* Card 1: Our Vision */}
          <div className={`about-card rounded-2xl border p-8 sm:p-10 transition-all duration-300 flex flex-col justify-between relative overflow-hidden ${
            isDark 
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <p className={`text-sm sm:text-base leading-relaxed ${isDark ? 'text-gray-300' : 'text-[#5a4225]'}`}>
                  To become a leading global platform that empowers individuals and businesses with diverse investment opportunities across real estate, financial markets, and digital assets, creating a future of sustainable growth, financial freedom, and long-term success.
                </p>
              </div>
            </div>
          ...
          <div className={`about-card rounded-2xl border p-8 sm:p-10 transition-all duration-300 flex flex-col justify-between relative overflow-hidden ${
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <p className={`text-sm sm:text-base leading-relaxed ${isDark ? 'text-gray-300' : 'text-[#5a4225]'}`}>
                  Our mission is to simplify access to wealth-building opportunities by providing a trusted, innovative, and user-friendly platform. We aim to connect people with real estate, stocks, mutual funds, cryptocurrency, and forex markets while promoting transparency, knowledge, and informed decision-making for every investor.
                </p>
              </div>
            </div>
