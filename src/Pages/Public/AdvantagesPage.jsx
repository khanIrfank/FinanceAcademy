...
const AdvantagesPage = () => {
  ...
  const comparisons = [
    { feature: "Real-Time Charts Feed", darkHorse: "Raw WebSocket data (no markups)", retailBrokers: "Broker-spread marked up data" },
    { feature: "Simulated Compounding tool", darkHorse: "Interactive radial radar compounding", retailBrokers: "Static manual formulas" },
    { feature: "Multi-Asset Options", darkHorse: "Forex, Stocks, Crypto, Real Estate", retailBrokers: "Single asset focus only" },
    { feature: "Structured Roadmap levels", darkHorse: "4-Stage levels with certifications", retailBrokers: "Random unsorted articles" },
    { feature: "Uptime and Latency", darkHorse: "99.98% uptime, <12ms API speed", retailBrokers: "Varies, highly lagging feeds" }
  ]
      ...
      <section className={`py-20 px-4 sm:px-6 lg:px-8 border-t ${
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 flex justify-center">
              <div className={`relative rounded-2xl p-6 border w-full max-w-sm transition-all duration-300 ${
                isDark 
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="overflow-x-auto rounded-2xl border border-gold-dark/25 shadow-2xl">
            <table className={`w-full text-left text-sm border-collapse ${
              isDark ? 'bg-dark-900/40 text-gray-300' : 'bg-white text-[#4a3a20]'
            }`}>
              <thead>
                <tr className={`border-b ${
                  isDark ? 'border-gold-dark/25 bg-dark-950' : 'border-gold-dark/30 bg-[#fdf8ef]'
                }`}>
              ...
              <tbody className="divide-y divide-gold-dark/10">
                {comparisons.map((item, idx) => (
                  ...
                  >
                    ...
                    <td className="p-4 font-bold text-xs text-gold-light">{item.darkHorse}</td>
